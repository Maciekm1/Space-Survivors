...
public class AutoCannonProj : Projectile
{
    ...
    protected void OnEnable()
    {
        ...
        Vector2 shotStrength = transform.up * projectileSpeed * PlayerController.Instance.GetPlayerStats().projectileSpeedMult * Mathf.Clamp(PlayerController.Instance.Rb.velocity.magnitude * playerVelocityMultiplier, 1f, PlayerController.Instance.Rb.velocity.magnitude * playerVelocityMultiplier);
